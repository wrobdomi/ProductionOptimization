var costboxone = false;
var timeboxone = false;

function setCostCon(){
	costboxone = !costboxone;	
}

function setTimeCon(){
	timeboxone = !timeboxone;	
}
...
function callmodelone() {
	...
	var criteria = {
			...
			cWeight: $("#cWeight").val(),
			tWeight: $("#tWeight").val(),
			costConEnabled: costboxone,
			timeConEnabled: timeboxone,
			costCon: $("#costCon").val(),
			timeCon: $("#timeCon").val()
	};
        ...
        success :function(response) {
            try {
               ...
               for(var i = 0 ; i < response.solution.length; i++ ){
                ...
                var listDeltaTemperature = [];
                for(var i = 0 ; i < response.listDeltaTemperature.length ; i++){
                	listDeltaTemperature[i] = response.listDeltaTemperature[i];
                }
