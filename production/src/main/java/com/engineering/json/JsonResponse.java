...
public class JsonResponse {
	...
	public JsonResponse(int[][] solution, int taskOffset, int initialEnergy, int finalEnergy, List<Integer> listLoopNum,
			List<Integer> listEnergy, List<Double> listTemperature, List<Double> listAcceptanceProb,
			List<Integer> listAcceptance, List<Integer> listTime, List<Integer> listCost, int machineOffset,
			int machineLength) {
		super();
